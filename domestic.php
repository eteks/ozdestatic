...
<html lang="en">
   <head>
      ...
      <link href="css/header-css/style3.css" rel="stylesheet">
          ...
          <div class="da-slide">
            ...
            <div class="image_one_mountain">
              <div class="header-slide-content">
                <p class="header-paragraph1">Its Better to</p>
                <p class="header-holiday1"> SEE SOMETHING <mark id="inbound_mark"> ONCE </mark> </h3>
                <p class="header-offer1"> than to heard about it a<mark id="inbound_mark1"> Thousands <mark id="inbound_mark2">Times </mark></mark></p>
                    ...
                    <section  class="jcarousel" data-jcarousel="true">
                      <ul style="left: -600px; top: 0px;">
                        <li>
                            ...
                            <img class="img-responsive" src="images/domestic/yercaud.png" alt="Yercaud-Hogenakkal">
                              <section class="overlay">
                                  <h2>Yercaud-Hogenakkal</h2>
                  				<!-- <p>Starting from &#8377; 2,000<sup>*</sup></p>  -->
                              </section>
                        ...
                        <li>
                            ...
                            <img class="img-responsive" src="images/domestic/valparai.png" alt="Valparai-Pollachi">
                              <section class="overlay">
                        ...
                        <li>
                            ...
                            <img class="img-responsive" src="images/domestic/pondichery.png" alt="pondichery">
                              <section class="overlay">
                                  <h2>Pondicherry</h2>
                  				<!-- <p>Starting from &#8377; 3,000<sup>*</sup></p>  -->
                              </section>
                              <section class="dummy_overlay">
                                </section>
                  			 </section>		  
