...
<html lang="en">
   <head>
	  ...
	  <link href="css/jcarousel.responsive.css" rel="stylesheet" >
       <link href="css/header-css/style5.css" rel="stylesheet">
          ...
          <div class="da-slide">
            ...
            <div class="image_one_mountain">
              <div class="header-slide-content">
                <p class="header-offer1"> Amazing </p>
                <p class="header-holiday1"> Tours for Your Dream Vacation <mark id="header-fade-content1">Dream Vacation </mark></h3>
