...
<html lang="en">
   <head>
      ...
      <link href="css/header-css/style4.css" rel="stylesheet">
...
<section class="hidden-xs">
        <div id="da-slider" class="container-fluid da-slider animation_cloud">
          ...
          <div class="da-slide">
            ...
            <!-- <p> </p> -->
            <div class="da-link right-mountain-people">
              <img src="images/outbound2.png" alt="image01" />
            </div>
            <div class="image_one_mountain">
              <div class="header-slide-content">
                <p class="header-paragraph1">People dont takes <mark id="inbound_mark"> Trips </mark> </p>
                <p class="header-holiday1"> Trips  <mark id="inbound_mark1">  takes people </mark> 
