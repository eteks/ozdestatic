        ...
        <section class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
         <section class="modal-dialog ">
          <section class="modal-content oza-modal-content">
            <form id="small_model_form form1" class="form-inline" name="small-model-form" method="post" action="smallmodel_send_email.php">
               ...
               <h4 class="oza-modal-title col-xs-12 col-sm-12 coll-md-12 col-lg-12">Basic Details</h4>
                ...
                <article class="form-group col-xs-12 col-sm-12 coll-md-12 col-lg-12">
                  ...
                  <select class="form-control" id="select_destination" name="Planningdestination" value="" required>
                ...
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                   ...
                   <input text="email" class="form-control" id="oza-modal-name" name="Name" placeholder="Name*" required>
                </article>
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                  <label class="sr-only" for="oza-modal-city">City</label>
                  <select class="form-control oza-text-placeholder city_list" id="City" name="City" required>
                ...
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                   ...
                   <input type="tel" class="form-control" id="oza-modal-mobile" name="Mobile" value="" placeholder="Mobile*" required>
                </article>
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                   <label class="sr-only" for="oza-modal-email">Email<sup>*</sup></label>
                   <input type="email" class="form-control" id="oza-modal-email" name="Email" value="" placeholder="Email*" required>
                </article>
                ...
                <article class="form-group col-xs-12 col-sm-12 coll-md-4 col-lg-4">
                  ...
                  <select class="form-control" id="Adult" name="Adult" value="" required>
              ...
              <article class="form-group col-xs-12 col-sm-12 coll-md-4 col-lg-4">
                 ...
                 <select class="form-control" id="Child" name="Child" value="" required>
              ...
              <article class="form-group col-xs-12 col-sm-12 coll-md-4 col-lg-4">
                ...
                <select class="form-control" name="Infant" value="" required>
      ...
      <section class="modal fade feadback" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
         <section class="modal-dialog">
            <section class="modal-content oza-modal-feedback-content">
               <form id="feedback_form form1" class="form-inline" name="feedback-form" method="post" action="feedback_send_email.php">
                ...
                <article class="form-group col-xs-12 col-sm-12 coll-md-12 col-lg-12">
                   ...
                   <select class="form-control" name="Countryvisited" required>
                ...
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                   <label class="sr-only" for="oza-modal-name">Name<sup>*</sup></label>
                   <input type="text" class="form-control" id="oza-modal-name" name="Name" placeholder="Name*" required>
                </article>
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                   <label class="sr-only" for="oza-modal-city">City</label>
                   <select class="form-control oza-text-placeholder" name="City" required>
                      <option value="">City*</option>
                ...
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                   ...
                   <input type="tel" class="form-control" id="oza-modal-mobile" name="Mobile" placeholder="Mobile*" required>
                </article>
                <article class="form-group col-xs-12 col-sm-12 coll-md-6 col-lg-6">
                   <label class="sr-only" for="oza-modal-email">Email<sup>*</sup></label>
                   <input type="email" class="form-control" id="oza-modal-email" name="Email" placeholder="Email*" required>
                </article>
                <article class="form-group col-xs-12 col-sm-12 coll-md-12 col-lg-12">
